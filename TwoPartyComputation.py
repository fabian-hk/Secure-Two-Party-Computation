...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Script for maliciously secure Two-Party Computation.',
                                     epilog='Example usage:\n\tpython3 TwoPartyComputation.py and_op 45 '
                                            'certificate-alice bob.mpc -s 10.10.1.42 -p 4444',
    ...
    parser.add_argument('certificate', type=str, help='Own certificate to authenticate your self to the other party.')
    parser.add_argument('partner', type=str, help='Common name of the partner you want to talk to.')
    ...
    com = Fpre(args.server, args.port, args.certificate, args.partner)
    mpc = MPC(com)
